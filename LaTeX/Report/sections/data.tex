...
Because consecutive frames were very similar, the division is done by using a pseudo-random randomise algorithm which used the same seed every time.
This resulted in three sets of images that have a high distribution of the original data while consisting of the same images within each run.
This dataset makes it possible to train the different algorithms used in this porject and test the accuracy with the amount of labels computed correctly.
